...
setvalue(e)  
  ...
  return (
    <div className="App">
      ...
      <Image alt ="dan"  src ="https://bit.ly/dan-abramov" height="150px" width="150px" fit ="cover" borderRadius="100px" />
      <br />
      <Input  type="text"  size= "md" varient="outline" value={value1} onChange={handlech} />
      <h1>{value1}</h1>
    </div>
  );
}
